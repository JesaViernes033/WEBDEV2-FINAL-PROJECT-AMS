    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                ...
                @else
                <img src="https://img.icons8.com/bubbles/452/system-administrator-female.png" class="user-image img-circle elevation-2 alt="User Image">
                @endif
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                @else
                <img src="https://img.icons8.com/bubbles/452/system-administrator-female.png" class="img-circle elevation-2" alt="User Image">
                @endif
